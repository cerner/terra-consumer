...
- Added a component DangerousHtml to render texts with special characters using dangerouslySetInnerHTML
...
- Rendered translated texts using component DangerousHtml.
